...
function verificarReserva() {
  ...
  if (!reserva) {
    ...
    p.innerHTML = "Nenhuma reserva encontrada com o CPF informado.";
    return undefined;
  }else{
...
if (!reserva) {
  alert("Nenhuma reserva encontrada com o CPF informado.");
  p.innerHTML = "Nenhuma reserva encontrada com o CPF informado. Não foi possível cancelar a reserva.";
  return;
}
